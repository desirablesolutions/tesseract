...
export default function LarryNavBarPreset() {
  <section>
      ...
      <div className="container px-4 mx-auto">
        <div className="flex items-center">
          ...
          <div className="ml-auto lg:hidden">
            <button className="flex items-center justify-center w-12 h-12 transition duration-200 bg-gray-100 rounded-md navbar-burger hover:bg-gray-200">
              <svg
                width={24}
                height={24}
                viewBox="0 0 24 24"
          ...
          <ul className="hidden lg:flex ml-14 lg:w-auto lg:space-x-12">
            <li className="relative group">
              <a
                className="inline-block text-sm font-medium text-gray-900 hover:text-orange-900"
                href="#"
              >
                Featured
              </a>
              <div className="absolute left-0 z-50 hidden max-w-xs p-4 group-hover:block top-full min-w-max">
                <div className="w-4 h-4 ml-8 -mb-2 transform rotate-45 bg-white border-t border-l border-gray-200 rounded-sm" />
                <div className="w-full max-w-xs px-4 pt-4 pb-4 bg-white border border-gray-100 rounded-3xl">
                  <div className="pb-3 mb-3 border-b border-gray-100">
                    <a
                      className="block px-4 py-3 text-sm text-gray-900 rounded-lg hover:bg-orange-50"
                      href="#"
                    >
                      Featured
                    </a>
                  ...
                  <div className="pb-3 mb-3 border-b border-gray-100">
                    <a
                      className="flex items-center px-4 py-3 mb-2 text-sm text-gray-900 rounded-lg hover:bg-orange-50"
                      href="#"
                    >
                      <img
                  ...
                  <div className="flex items-center pb-3 mb-3 border-b border-gray-100">
                    ...
                    <a
                      className="inline-block px-4 py-3 text-sm font-semibold text-orange-900 transition duration-200 border border-gray-200 rounded-md hover:text-white hover:border-orange-600 hover:bg-orange-900"
                      href="#"
                    >
                      Create an account
                    </a>
          ...
          <div className="hidden ml-auto lg:block">
            <div className="flex items-center">
              <a
                className="inline-block text-sm font-semibold text-orange-900 mr-9 hover:text-gray-900"
                href="#"
              >
                Sign In
              </a>
              <a
                className="relative inline-block px-4 py-3 overflow-hidden text-sm font-semibold text-orange-900 transition duration-300 border border-gray-200 rounded-md group hover:text-white"
                href="#"
              >
                <div className="absolute top-0 w-full h-full transition duration-500 transform bg-orange-900 right-full group-hover:translate-x-full group-hover:scale-102" />
    ...
    <div className="fixed top-0 bottom-0 left-0 z-50 hidden w-5/6 max-w-md navbar-menu">
      ...
      <nav className="relative flex flex-col w-full h-full px-10 py-6 overflow-y-auto bg-white border-r">
        ...
        <div>
          <ul className="mb-2">
            <li>
              <a
                className="block px-5 py-4 text-gray-900 rounded-lg hover:bg-orange-50"
                href="#"
              >
                About Us
              </a>
          ...
          <div className="px-6 py-8 mb-6 border-t border-b border-gray-200">
            <a
          ...
          <div className="flex items-center px-6 mb-16">
            ...
            <a
              className="inline-block px-4 py-3 text-sm font-semibold text-orange-900 transition duration-200 border border-gray-300 rounded-md hover:text-white hover:border-orange-600 hover:bg-orange-900"
              href="#"
            >
              Create an account
            </a>
          ...
          <div>
            <div className="flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-orange-50">
              <svg
                width={29}
                height={28}
                viewBox="0 0 29 28"
